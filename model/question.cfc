component persistent="true" {
	...
	property name="answers" fieldType="many-to-many" cfc="answer" linktable="question_answer" fkcolumn="questionidfk" inversejoincolumn="answeridfk" lazy="true" singularname="answer";
